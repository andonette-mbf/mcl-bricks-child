      ...
      <div class="brxe-block">
        ...
        <div class="delegate-fields">
          <div class="step-inputs-split">
            ...
            <input name="delegate_level[{X}]" data-number="{X}" required class="delegate_level" value="" placeholder="Delegate {X} Level">
          ...
          <div>
            <div class="review-booking-block">
              <div class="meta">
                ...
                <span class="title duration"><i class="far fa-clock"></i> <?php echo $duarionTime[0];?> <?php echo $duarionType[0];?> course</span>
              </div>
            </div>
          </div>
