                  ...
                  <div id="delegate-details">
                    ...
                    <div class="delegate-fields">
                      <div class="step-inputs-split">
                        ...
                        <select name="delegate_level[{X}]" data-number="{X}" required class="delegate_level" onchange="toggleIRATAField(this)">
                          <option value="">Select Level</option>
                          <option value="1">Level 1</option>
                          <option value="2">Level 2</option>
                          <option value="3">Level 3</option>
                        </select>
                        <input name="delegate_irata_number[{X}]" data-number="{X}" required class="delegate_irata_number" value="" placeholder="Delegate {X} IRATA Number" style="display: none;">
                    ...
                    <script>
                      function toggleIRATAField(selectElement) {
                        const irataField = selectElement.nextElementSibling;
                        if (selectElement.value === "2" || selectElement.value === "3") {
                          irataField.style.display = "block";
                          irataField.required = true;
                        } else {
                          irataField.style.display = "none";
                          irataField.required = false;
                        }
                      }
                    </script>
                    ```
      ...
      <?php if ($product->is_type('booking')) { ?>
        <script>
          ...
          ?>
            ...
            jQue ry(document).ready(function() {
          ...
          <?php } ?>
            ...
            div id = "brxe-tabs"
          data - script - id = "tabs"
          class = "brxe-tabs-nested" >
          <
          div id = "brxe-pljtos"
          class = "brxe-block tab-menu" >
          <
          ...
          foreach ($terms as $term) {
            ...
            <
            a href = "<?php echo get_term_link('training-courses', 'product_cat'); ?>"
          class = "float-right title-link" > See all training courses < /a> < /
          div >
