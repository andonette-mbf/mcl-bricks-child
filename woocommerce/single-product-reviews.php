...
?>
<div id="reviews" class="woocommerce-Reviews float-left w-100 position-relative">
	<div class="float-left w-100 position-relative" id="comments">
	...
	<?php if ( get_option( 'woocommerce_review_rating_verification_required' ) === 'no' || wc_customer_bought_product( '', get_current_user_id(), $product->get_id() ) ) : ?>
		<div class="float-left w-100 position-relative" id="review_form_wrapper">
			<div class="float-left w-100 position-relative" id="review_form">
				<?php
