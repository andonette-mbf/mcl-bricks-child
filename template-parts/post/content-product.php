            ...
            <a href="<?php the_permalink (); ?>" class="post-thumbnail-outer float-left w-100 position-relative">
                <div class="post-thumbnail-outer float-left w-100 position-relative">
                    <?php if ( get_field ( 'preview_thumbnail' ) ) { ?>
                        ...
                        ?>
                        <img class="vhboth" src="<?php echo $fullImage[ 0 ]; ?>"
                            alt="<?php echo get_post_meta ( $fullAttachmentId, '_wp_attachment_image_alt', true ) ?>" />
                ...
                <div class="post-content float-left w-100 position-relative">
                    <h3 class="float-left w-100 position-relative" title="<?php the_title (); ?>"><?php the_title (); ?>
                    </h3>

                    <p class="price title float-left w-100 position-relative"><?php echo $product->get_price_html (); ?>
                    </p>
                </div>
