                        ...
                        <div class="col-12 col-md-7 align-self-center anime-view">
                            ...
                            <div class="slider-search-bar to-animate float-left w-100 position-relative">
								...
								<div class="form-inner float-left w-100">
									<form class="slider-form float-left w-100 new-slider-style">
										<div class="fields dropdown-selects no-margin">
											<div class="fields half no-margin">
												<label>
													<select name="course" placeholder="Select a course" id="course">
											...
											<div class="fields half right no-margin location-select">
												<label>
													<select name="location" placeholder="Select location" id="location">
                                        ...
                                        <a href="#" class="clear-selections-slider">Clear Selections</a>
									</form>
								</div>
							</div>
                        </div>
